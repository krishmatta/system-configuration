...
(custom-set-variables
 ...
 '(package-selected-packages
   '(magit ein-notebook ein quelpa pdf-continuous-scroll-mode pdf-view-restore org-roam-ui websocket elfeed ewal-evil-cursors ewal-spacemacs-themes ewal orderless which-key vertico use-package pdf-tools ox-hugo org-roam org-gtd org-download marginalia general evil-collection doom-modeline amx all-the-icons)))
(custom-set-faces
